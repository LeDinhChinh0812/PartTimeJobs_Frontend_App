        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            >
                ...
                >
                    ...
                    {renderInput('Mã sinh viên', 'studentId', 'VD: SV001234')}
                    {renderInput('Trường', 'university', 'VD: Đại học Bách Khoa Hà Nội')}
                    {renderInput('Chuyên ngành', 'major', 'VD: Công nghệ thông tin')}
                    {renderInput('GPA', 'gpa', 'VD: 3.5', {
                        keyboardType: 'decimal-pad'
                    })}
                    {renderInput('Năm học', 'yearOfStudy', 'VD: 3', {
                        keyboardType: 'number-pad'
                    })}

                    {/* Skills */}
                    <Text style={styles.sectionTitle}>Kỹ năng</Text>
                    {renderInput('Kỹ năng', 'skills', 'Nhập các kỹ năng cách nhau bởi dấu phẩy.\nVD: React Native, Node.js, Photoshop, Teamwork', {
                        multiline: true,
                        numberOfLines: 3,
                    })}
                    ...
                    {renderInput('Link CV', 'resumeUrl', 'https://...', {
                        autoCapitalize: 'none',
                        keyboardType: 'url'
                    })}
                    {renderInput('LinkedIn', 'linkedInUrl', 'https://linkedin.com/in/...', {
                        autoCapitalize: 'none',
                        keyboardType: 'url'
                    })}
                    {renderInput('GitHub', 'gitHubUrl', 'https://github.com/...', {
                        autoCapitalize: 'none',
                        keyboardType: 'url'
                    })}
